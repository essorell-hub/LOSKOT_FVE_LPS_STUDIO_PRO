// MEGA PACK O — V136–V140 Final Acceptance / Field Check Protocols - noVoltageProtocolModelV137
// Pure runtime helper. No DOM. No package dependency.

export function noVoltageProtocolModelV137(protocol = {}, options = {}) {
  ...
  return {
    pack: "O",
    module: "noVoltageProtocolModelV137",
