...
export const DOCUMENTS_EXPORT_RUNTIME_WINDOWS_BUILD_PREP_V339_VERSION = 'v339-documents-export-runtime-windows-build-prep-v339';

export function createDocumentsExportRuntimeWindowsBuildPrepV339(options = {}) {
  ...
  const model = {
    modelVersion: DOCUMENTS_EXPORT_RUNTIME_WINDOWS_BUILD_PREP_V339_VERSION,
    versionNumber: 339,
    phaseId: 'V321-V340',
...
export function validateDocumentsExportRuntimeWindowsBuildPrepV339(model = createDocumentsExportRuntimeWindowsBuildPrepV339()) {
  const errors = [];
  if (model.modelVersion !== DOCUMENTS_EXPORT_RUNTIME_WINDOWS_BUILD_PREP_V339_VERSION) errors.push('Unexpected model version.');
  if (model.versionNumber !== 339) errors.push('Unexpected version number.');
  ...
  if (!model.metrics || model.metrics.runtimeStep !== 339) errors.push('Runtime step invalid.');
