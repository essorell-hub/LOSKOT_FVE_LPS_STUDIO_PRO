// MEGA PACK H — V101–V105 Equipment Catalog / Datasheet Engine - equipmentCatalogCoreV101
// Pure runtime helper. No DOM. No package dependency.

export function equipmentCatalogCoreV101(catalog = {}, options = {}) {
  ...
  return {
    pack: "H",
    module: "equipmentCatalogCoreV101",
