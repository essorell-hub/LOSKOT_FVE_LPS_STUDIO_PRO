// MEGA PACK E — V81–V85 Documents / Reporting / Export Upgrade - exportManifestBuilderV83
// Pure runtime helper. No DOM. No package dependency.

export function exportManifestBuilderV83(project = {}, options = {}) {
  ...
  return {
    pack: "E",
    module: "exportManifestBuilderV83",
