// MEGA PACK E — V81–V85 Documents / Reporting / Export Upgrade - documentTemplateRegistryV81
// Pure runtime helper. No DOM. No package dependency.

export function documentTemplateRegistryV81(project = {}, options = {}) {
  ...
  return {
    pack: "E",
    module: "documentTemplateRegistryV81",
