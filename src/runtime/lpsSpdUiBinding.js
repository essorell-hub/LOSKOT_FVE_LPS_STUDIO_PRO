...
export const V69_LPS_SPD_UI_BINDING_VERSION = "v69-lps-spd-ui-binding";

const MODULE_NAME = "lpsSpdUiBinding";
...
function createResult(action, data = null, warnings = [], errors = []) {
  return createRuntimeResult({
    ...
    errors,
    meta: {
      moduleVersion: V69_LPS_SPD_UI_BINDING_VERSION,
...
export function createLpsSpdUiBinding(options = {}) {
  function getPurpose() {
    return createResult("getPurpose", {
      version: V69_LPS_SPD_UI_BINDING_VERSION,
      purpose: "Napojení LPS/SPD/LPZ dat do UI, inspectoru, QA a dokumentů.",
      classicProUnchanged: true
    });
  }
...
export function safeLpsSpdUiBinding(options = {}) {
  try {
    return createLpsSpdUiBinding(options);
  } catch (error) {
    return {
      version: V69_LPS_SPD_UI_BINDING_VERSION,
      classicProUnchanged: true,
