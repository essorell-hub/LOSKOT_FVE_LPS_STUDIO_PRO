...
export const DOCUMENTS_EXPORT_RUNTIME_SCHEMA_EXPORT_MODEL_V326_VERSION = 'v326-documents-export-runtime-schema-export-model-v326';

export function createDocumentsExportRuntimeSchemaExportModelV326(options = {}) {
  ...
  const model = {
    modelVersion: DOCUMENTS_EXPORT_RUNTIME_SCHEMA_EXPORT_MODEL_V326_VERSION,
    versionNumber: 326,
    phaseId: 'V321-V340',
...
export function validateDocumentsExportRuntimeSchemaExportModelV326(model = createDocumentsExportRuntimeSchemaExportModelV326()) {
  const errors = [];
  if (model.modelVersion !== DOCUMENTS_EXPORT_RUNTIME_SCHEMA_EXPORT_MODEL_V326_VERSION) errors.push('Unexpected model version.');
  if (model.versionNumber !== 326) errors.push('Unexpected version number.');
  ...
  if (!model.metrics || model.metrics.runtimeStep !== 326) errors.push('Runtime step invalid.');
