...
export const LPS_SPD_RUNTIME_EQUIPOTENTIAL_BONDING_MODEL_V308_VERSION = 'v308-lps-spd-runtime-equipotential-bonding-model-v308';

export function createLpsSpdRuntimeEquipotentialBondingModelV308(options = {}) {
  ...
  const model = {
    modelVersion: LPS_SPD_RUNTIME_EQUIPOTENTIAL_BONDING_MODEL_V308_VERSION,
    versionNumber: 308,
    phaseId: 'V301-V320',
...
export function validateLpsSpdRuntimeEquipotentialBondingModelV308(model = createLpsSpdRuntimeEquipotentialBondingModelV308()) {
  const errors = [];
  if (model.modelVersion !== LPS_SPD_RUNTIME_EQUIPOTENTIAL_BONDING_MODEL_V308_VERSION) errors.push('Unexpected model version.');
  if (model.versionNumber !== 308) errors.push('Unexpected version number.');
  ...
  if (!model.metrics || model.metrics.runtimeStep !== 308) errors.push('Runtime step invalid.');
