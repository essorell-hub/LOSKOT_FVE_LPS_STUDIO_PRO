// MEGA PACK F — V91–V95 Release Hardening / Diagnostics / Backup - diagnosticsCollectorV92
// Pure runtime helper. No DOM. No package dependency.

export function diagnosticsCollectorV92(project = {}, options = {}) {
  ...
  return {
    pack: "F",
    module: "diagnosticsCollectorV92",
