// MEGA PACK G — V96–V100 Windows Release Candidate Handoff - handoffPackageBuilderV99
// Pure runtime helper. No DOM. No package dependency.

export function handoffPackageBuilderV99(project = {}, options = {}) {
  ...
  return {
    pack: "G",
    module: "handoffPackageBuilderV99",
