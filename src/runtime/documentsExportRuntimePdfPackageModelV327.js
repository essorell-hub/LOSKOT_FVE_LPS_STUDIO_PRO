...
export const DOCUMENTS_EXPORT_RUNTIME_PDF_PACKAGE_MODEL_V327_VERSION = 'v327-documents-export-runtime-pdf-package-model-v327';

export function createDocumentsExportRuntimePdfPackageModelV327(options = {}) {
  ...
  const model = {
    modelVersion: DOCUMENTS_EXPORT_RUNTIME_PDF_PACKAGE_MODEL_V327_VERSION,
    versionNumber: 327,
    phaseId: 'V321-V340',
...
export function validateDocumentsExportRuntimePdfPackageModelV327(model = createDocumentsExportRuntimePdfPackageModelV327()) {
  const errors = [];
  if (model.modelVersion !== DOCUMENTS_EXPORT_RUNTIME_PDF_PACKAGE_MODEL_V327_VERSION) errors.push('Unexpected model version.');
  if (model.versionNumber !== 327) errors.push('Unexpected version number.');
  ...
  if (!model.metrics || model.metrics.runtimeStep !== 327) errors.push('Runtime step invalid.');
