...
export const DOCUMENTS_EXPORT_RUNTIME_JSON_PROJECT_EXPORT_V329_VERSION = 'v329-documents-export-runtime-json-project-export-v329';

export function createDocumentsExportRuntimeJsonProjectExportV329(options = {}) {
  ...
  const model = {
    modelVersion: DOCUMENTS_EXPORT_RUNTIME_JSON_PROJECT_EXPORT_V329_VERSION,
    versionNumber: 329,
    phaseId: 'V321-V340',
...
export function validateDocumentsExportRuntimeJsonProjectExportV329(model = createDocumentsExportRuntimeJsonProjectExportV329()) {
  const errors = [];
  if (model.modelVersion !== DOCUMENTS_EXPORT_RUNTIME_JSON_PROJECT_EXPORT_V329_VERSION) errors.push('Unexpected model version.');
  if (model.versionNumber !== 329) errors.push('Unexpected version number.');
  ...
  if (!model.metrics || model.metrics.runtimeStep !== 329) errors.push('Runtime step invalid.');
