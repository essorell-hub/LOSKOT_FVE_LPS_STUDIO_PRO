// MEGA PACK L — V121–V125 Performance / Cache / Large Project Engine - cadSpatialIndexDraftV124
// Pure runtime helper. No DOM. No package dependency.

export function cadSpatialIndexDraftV124(project = {}, options = {}) {
  ...
  return {
    pack: "L",
    module: "cadSpatialIndexDraftV124",
