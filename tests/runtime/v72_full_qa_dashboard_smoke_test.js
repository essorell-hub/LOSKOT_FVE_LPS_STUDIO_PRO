...
} from "../../src/runtime/fullQaDashboardRuntime.js";

assert.equal(V72_FULL_QA_DASHBOARD_VERSION, "v72-full-qa-dashboard");

const engine = createFullQaDashboardRuntime();
...
assert.equal(safeFullQaDashboardRuntime().run("getPurpose").ok, true);

console.log("v72 full-qa-dashboard smoke test OK");
