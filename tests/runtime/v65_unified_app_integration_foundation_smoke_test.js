...
} from "../../src/runtime/unifiedAppIntegration.js";

assert.equal(V65_UNIFIED_APP_INTEGRATION_FOUNDATION_VERSION, "v65-unified-app-integration-foundation");

const engine = createUnifiedAppIntegration();
...
assert.equal(safeUnifiedAppIntegration().run("getPurpose").ok, true);

console.log("v65 unified-app-integration-foundation smoke test OK");
