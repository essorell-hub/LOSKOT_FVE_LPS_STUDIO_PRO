...
console.log('Starting V381-V400 functional smoke test...');

const routeKeys = ['dashboard'];
const allResults = [];
for (const routeKey of routeKeys) {
  const project = { id: 'V381-V400-' + routeKey, name: 'documents export functional core', revision: 'smoke' };
  const results = [];
    {
...
console.log('V381-V400 functional smoke test passed:', JSON.stringify({
  phaseId: 'V381-V400',
