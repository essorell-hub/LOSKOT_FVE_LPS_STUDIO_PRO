...
} from "../../src/runtime/documentsUiBinding.js";

assert.equal(V70_DOCUMENTS_UI_BINDING_VERSION, "v70-documents-ui-binding");

const engine = createDocumentsUiBinding();
...
assert.equal(safeDocumentsUiBinding().run("getPurpose").ok, true);

console.log("v70 documents-ui-binding smoke test OK");
