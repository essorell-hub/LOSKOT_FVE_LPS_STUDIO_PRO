...
console.log('Starting V361-V380 functional smoke test...');

const routeKeys = ['dashboard'];
const allResults = [];
for (const routeKey of routeKeys) {
  const project = { id: 'V361-V380-' + routeKey, name: 'LPS SPD functional core', revision: 'smoke' };
  const results = [];
    {
...
console.log('V361-V380 functional smoke test passed:', JSON.stringify({
  phaseId: 'V361-V380',
