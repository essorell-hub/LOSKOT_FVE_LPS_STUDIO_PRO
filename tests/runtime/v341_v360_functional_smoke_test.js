...
console.log('Starting V341-V360 functional smoke test...');

const routeKeys = ['dashboard'];
const allResults = [];
for (const routeKey of routeKeys) {
  const project = { id: 'V341-V360-' + routeKey, name: 'FVE functional core', revision: 'smoke' };
  const results = [];
    {
...
console.log('V341-V360 functional smoke test passed:', JSON.stringify({
  phaseId: 'V341-V360',
