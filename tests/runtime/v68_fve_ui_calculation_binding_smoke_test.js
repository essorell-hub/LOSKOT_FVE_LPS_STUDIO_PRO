...
} from "../../src/runtime/fveUiCalculationBinding.js";

assert.equal(V68_FVE_UI_CALCULATION_BINDING_VERSION, "v68-fve-ui-calculation-binding");

const engine = createFveUiCalculationBinding();
...
assert.equal(safeFveUiCalculationBinding().run("getPurpose").ok, true);

console.log("v68 fve-ui-calculation-binding smoke test OK");
