...
console.log('Starting V281-V300 smoke test...');

const routeKeys = ['dashboard'];
const allResults = [];
for (const activeRouteKey of routeKeys) {
  const projectContext = { projectId: 'V281-V300-' + activeRouteKey, projectName: 'FVE runtime production layer', revision: 'smoke' };
  const results = [];
    {
...
console.log('V281-V300 smoke test passed:', JSON.stringify({
  phaseId: 'V281-V300',
