...
} from "../../src/runtime/exportPackageUiBinding.js";

assert.equal(V71_EXPORT_PACKAGE_UI_BINDING_VERSION, "v71-export-package-ui-binding");

const engine = createExportPackageUiBinding();
...
assert.equal(safeExportPackageUiBinding().run("getPurpose").ok, true);

console.log("v71 export-package-ui-binding smoke test OK");
