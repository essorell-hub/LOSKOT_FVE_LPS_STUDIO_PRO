...
import {
  ...
  safeLpsSpdUiBinding
} from "../../src/runtime/lpsSpdUiBinding.js";

assert.equal(V69_LPS_SPD_UI_BINDING_VERSION, "v69-lps-spd-ui-binding");

const engine = createLpsSpdUiBinding();
...
assert.equal(safeLpsSpdUiBinding().run("getPurpose").ok, true);

console.log("v69 lps-spd-ui-binding smoke test OK");
